...
export const DICTIONARY = {
  fr: {
    ...
    scanSketchBtn: 'Scanner Croquis IA',
    ...
    sketchPrompt: 'Vous avez un croquis papier ou une photo ?',
    sketchScanLink: 'Scannez-le par IA',
  ...
  ar: {
    ...
    scanSketchBtn: 'مسح المخطط بالذكاء الاصطناعي',
    ...
    sketchPrompt: 'لديك رسم يدوي على ورقة أو صورة بقياسات حية؟',
    sketchScanLink: 'امسحه بالذكاء الاصطناعي',
  ...
  en: {
    ...
    scanSketchBtn: 'AI Sketch Scanner',
    ...
    sketchPrompt: 'Have a hand-drawn sketch or site photo?',
    sketchScanLink: 'Scan with AI Vision',
